...
<body style="margin-top:5em">
    ...
    <form class="form" style="margin-left:15em;" method="POST" action="searchData.php">
        ...
        <!-- <div style="display:flex">
            <div>
                <h2>left botton lattitude</h2><input class="input" type="text" name="file" id="file">
                <h2>right top lattitude</h2><input class="input" type="text" name="file" id="file">
            </div>
            <div>
                <h2>left bottom longitude</h2><input class="input" type="text" name="file" id="file">
                <h2>right top longitude</h2><input class="input" type="text" name="file" id="file">
            </div>
        </div>
        <div style="display:flex;">
